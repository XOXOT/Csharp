...
namespace CommandTest
{
    public partial class Form1 : Form
    {
        ...
        private void btnDelete_Click_1(object sender, EventArgs e)
        {
            ...
            string Sql = ($"DELETE tblPeople WHERE Name = '{choice}'");
            SqlCommand Com = new SqlCommand(Sql, Con);
            Com.ExecuteNonQuery();
            PrintTable();
        }
        ...
        private void btnInsert1_Click(object sender, EventArgs e)
        {
            if(checkFemale.Checked)
            {
                ...
                textName.Text, textAge.Text, checkFemale.Checked ? 0 : 1);
                SqlCommand Com = new SqlCommand(Sql, Con);
                Com.ExecuteNonQuery();
                PrintTable();
            }
        ...
        private void btnInsert2_Click(object sender, EventArgs e)
        {
            ...
            {
                string Sql = "INSERT INTO tblPeople VALUES (@Name,@Age,@Female)";
                SqlCommand Com = new SqlCommand(Sql, Con);
                Com.Parameters.Add("@Name", SqlDbType.NVarChar, 10);
                Com.Parameters.Add("@Age", SqlDbType.Int);
                Com.Parameters.Add("@Female", SqlDbType.Bit);
                Com.Parameters["@Name"].Value = textName.Text;
                Com.Parameters["@Age"].Value = textAge.Text;
                Com.Parameters["@Female"].Value = checkFemale.Checked ? 0 : 1;
                Com.ExecuteNonQuery();
                PrintTable();
            }
        }
